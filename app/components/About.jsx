          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <li
                ...
                hover:bg-lightHover hover:-translate-y-1 hover:shadow-dark duration-500 transition-colors
                dark:border-white dark:hover:shadow-bg-white dark:hover:bg-darkHover"
              >
